    ...
    <div className="min-h-screen flex flex-col bg-[#FBF9F5]">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-28 pb-16 space-y-8">
        <div className="space-y-2">
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#111111]">Contact Support</h1>
          <p className="text-sm text-[#55524C]">Have questions or need help with your localized Reels? Get in touch.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 rounded-3xl bg-white border border-[#121212]/10 shadow-xs space-y-3">
            ...
            <p className="text-sm font-mono font-semibold text-[#111111]">support@gowider.app</p>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-white border border-[#121212]/10 shadow-xs space-y-3">
            ...
            <p className="text-sm font-mono font-semibold text-[#111111]">feedback@gowider.app</p>
          </div>
        </div>
      </main>
      <Footer />
